...
class UsuariosTableMap extends TableMap
{
     ...
     */
    public const TABLE_PHP_NAME = 'Usuarios';
     ...
     */
    public const COL_ID_USUARIO = 'usuarios.id_usuario';
     ...
     */
    public const COL_PASS = 'usuarios.pass';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdUsuario', 'Usuario', 'Pass', ],
        self::TYPE_CAMELNAME     => ['idUsuario', 'usuario', 'pass', ],
        self::TYPE_COLNAME       => [UsuariosTableMap::COL_ID_USUARIO, UsuariosTableMap::COL_USUARIO, UsuariosTableMap::COL_PASS, ],
        self::TYPE_FIELDNAME     => ['id_usuario', 'usuario', 'pass', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdUsuario' => 0, 'Usuario' => 1, 'Pass' => 2, ],
        self::TYPE_CAMELNAME     => ['idUsuario' => 0, 'usuario' => 1, 'pass' => 2, ],
        self::TYPE_COLNAME       => [UsuariosTableMap::COL_ID_USUARIO => 0, UsuariosTableMap::COL_USUARIO => 1, UsuariosTableMap::COL_PASS => 2, ],
        self::TYPE_FIELDNAME     => ['id_usuario' => 0, 'usuario' => 1, 'pass' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'idUsuario' => 'ID_USUARIO',
        'usuarios.idUsuario' => 'ID_USUARIO',
        'UsuariosTableMap::COL_ID_USUARIO' => 'ID_USUARIO',
        ...
        'pass' => 'PASS',
        'usuarios.pass' => 'PASS',
        'UsuariosTableMap::COL_PASS' => 'PASS',
        'COL_PASS' => 'PASS',
    ];
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuariosTableMap::COL_PASS);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(UsuariosTableMap::COL_ID_USUARIO);
            $criteria->removeSelectColumn(UsuariosTableMap::COL_USUARIO);
            $criteria->removeSelectColumn(UsuariosTableMap::COL_PASS);
        } else {
