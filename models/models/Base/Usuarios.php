...
abstract class Usuarios implements ActiveRecordInterface
{
    ...
    public function setPass($v)
    {
        ...
        if ($this->pass !== $v) {
            $this->pass = $v;
            $this->modifiedColumns[UsuariosTableMap::COL_PASS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UsuariosTableMap::translateFieldName('Pass', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_PASS)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_PASS)) {
            $criteria->add(UsuariosTableMap::COL_PASS, $this->pass);
        }
