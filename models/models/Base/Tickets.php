...
abstract class Tickets implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\models\\Map\\TicketsTableMap';
    ...
    /**
     * The value for the nom_completo field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of models\Base\Tickets object.
     */
    ...
    /**
     * Get the [nom_completo] column value.
     *
     * @return string
     */
    ...
    public function setIdTicket($v)
    {
        ...
        if ($this->id_ticket !== $v) {
            $this->id_ticket = $v;
            $this->modifiedColumns[TicketsTableMap::COL_ID_TICKET] = true;
        }
    ...
    /**
     * Set the value of [nom_completo] column.
     *
     * @param string $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setNomCompleto($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->nom_completo !== $v) {
            $this->nom_completo = $v;
            $this->modifiedColumns[TicketsTableMap::COL_NOM_COMPLETO] = true;
        }
    ...
    public function setCurp($v)
    {
        ...
        if ($this->curp !== $v) {
            $this->curp = $v;
            $this->modifiedColumns[TicketsTableMap::COL_CURP] = true;
        }
    ...
    public function setNombres($v)
    {
        ...
        if ($this->nombres !== $v) {
            $this->nombres = $v;
            $this->modifiedColumns[TicketsTableMap::COL_NOMBRES] = true;
        }
    ...
    public function setPaterno($v)
    {
        ...
        if ($this->paterno !== $v) {
            $this->paterno = $v;
            $this->modifiedColumns[TicketsTableMap::COL_PATERNO] = true;
        }
    ...
    public function setMaterno($v)
    {
        ...
        if ($this->materno !== $v) {
            $this->materno = $v;
            $this->modifiedColumns[TicketsTableMap::COL_MATERNO] = true;
        }
    ...
    public function setTelefono($v)
    {
        ...
        if ($this->telefono !== $v) {
            $this->telefono = $v;
            $this->modifiedColumns[TicketsTableMap::COL_TELEFONO] = true;
        }
    ...
    public function setCelular($v)
    {
        ...
        if ($this->celular !== $v) {
            $this->celular = $v;
            $this->modifiedColumns[TicketsTableMap::COL_CELULAR] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[TicketsTableMap::COL_EMAIL] = true;
        }
    ...
    public function setNivel($v)
    {
        ...
        if ($this->nivel !== $v) {
            $this->nivel = $v;
            $this->modifiedColumns[TicketsTableMap::COL_NIVEL] = true;
        }
    ...
    public function setEstatus($v)
    {
        ...
        if ($this->estatus !== $v) {
            $this->estatus = $v;
            $this->modifiedColumns[TicketsTableMap::COL_ESTATUS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TicketsTableMap::translateFieldName('IdTicket', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_ticket = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TicketsTableMap::translateFieldName('NomCompleto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nom_completo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TicketsTableMap::translateFieldName('Curp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->curp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TicketsTableMap::translateFieldName('Nombres', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombres = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TicketsTableMap::translateFieldName('Paterno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->paterno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TicketsTableMap::translateFieldName('Materno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->materno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TicketsTableMap::translateFieldName('Telefono', TableMap::TYPE_PHPNAME, $indexType)];
            $this->telefono = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : TicketsTableMap::translateFieldName('Celular', TableMap::TYPE_PHPNAME, $indexType)];
            $this->celular = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : TicketsTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : TicketsTableMap::translateFieldName('Nivel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nivel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : TicketsTableMap::translateFieldName('Estatus', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = TicketsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\models\\Tickets'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(TicketsTableMap::COL_ID_TICKET)) {
            $modifiedColumns[':p' . $index++]  = 'id_ticket';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_NOM_COMPLETO)) {
            $modifiedColumns[':p' . $index++]  = 'nom_completo';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_CURP)) {
            $modifiedColumns[':p' . $index++]  = 'curp';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_NOMBRES)) {
            $modifiedColumns[':p' . $index++]  = 'nombres';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_PATERNO)) {
            $modifiedColumns[':p' . $index++]  = 'paterno';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_MATERNO)) {
            $modifiedColumns[':p' . $index++]  = 'materno';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_TELEFONO)) {
            $modifiedColumns[':p' . $index++]  = 'telefono';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_CELULAR)) {
            $modifiedColumns[':p' . $index++]  = 'celular';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_NIVEL)) {
            $modifiedColumns[':p' . $index++]  = 'nivel';
        }
        if ($this->isColumnModified(TicketsTableMap::COL_ESTATUS)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_ticket':
                        ...
                        break;
                    case 'nom_completo':
                        $stmt->bindValue($identifier, $this->nom_completo, PDO::PARAM_STR);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            ...
            $keys[1] => $this->getNomCompleto(),
            $keys[2] => $this->getCurp(),
            $keys[3] => $this->getNombres(),
            $keys[4] => $this->getPaterno(),
            $keys[5] => $this->getMaterno(),
            $keys[6] => $this->getTelefono(),
            $keys[7] => $this->getCelular(),
            $keys[8] => $this->getEmail(),
            $keys[9] => $this->getNivel(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdTicket($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setNomCompleto($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setCurp($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setNombres($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setPaterno($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setMaterno($arr[$keys[5]]);
        }
        ...
        if (array_key_exists($keys[9], $arr)) {
            $this->setNivel($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setEstatus($arr[$keys[10]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(TicketsTableMap::COL_ID_TICKET)) {
            $criteria->add(TicketsTableMap::COL_ID_TICKET, $this->id_ticket);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_NOM_COMPLETO)) {
            $criteria->add(TicketsTableMap::COL_NOM_COMPLETO, $this->nom_completo);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_CURP)) {
            $criteria->add(TicketsTableMap::COL_CURP, $this->curp);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_NOMBRES)) {
            $criteria->add(TicketsTableMap::COL_NOMBRES, $this->nombres);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_PATERNO)) {
            $criteria->add(TicketsTableMap::COL_PATERNO, $this->paterno);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_MATERNO)) {
            $criteria->add(TicketsTableMap::COL_MATERNO, $this->materno);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_TELEFONO)) {
            $criteria->add(TicketsTableMap::COL_TELEFONO, $this->telefono);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_CELULAR)) {
            $criteria->add(TicketsTableMap::COL_CELULAR, $this->celular);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_EMAIL)) {
            $criteria->add(TicketsTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_NIVEL)) {
            $criteria->add(TicketsTableMap::COL_NIVEL, $this->nivel);
        }
        if ($this->isColumnModified(TicketsTableMap::COL_ESTATUS)) {
            $criteria->add(TicketsTableMap::COL_ESTATUS, $this->estatus);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \models\Tickets (or compatible) type.
    ...
    {
        $copyObj->setNomCompleto($this->getNomCompleto());
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \models\Tickets Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
