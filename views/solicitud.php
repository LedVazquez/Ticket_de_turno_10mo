    ...
    <form method="post" class="formulario" id="formulario">
      ...
      <div>
        ...
        <select id="municipio" name="municipio">
          ...
          <option value="ramosarizpe">Ramos Arizpe</option>
          <option value="torreon">Torreon</option>
          <option value="acuna">Acuña</option>
        </select>
      </div>
      <div class="campo">
        <button class="btn btn-primary" id="check" style="display:block" type="button" onclick="validate()">Check</button>
        <button id="submit" style="display:none" type="submit">Obtener número de ticket</button>
      </div>
    </form>
